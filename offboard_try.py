...
if __name__=="__main__":
	...
	while not rospy.is_shutdown():
		...
		poses = ((0,0,10),(10,0,10),(10,10,10),(0,10,10))
		...
		if ((round(gx) == 0) and (round(gy) == 0) and (round(gz) == 10)):
			print("############################  Reached  %%%%%%%%%%%%")
			data_state = "reached_pose1"
			rospy.sleep(2000)
			# if count > 100:
		
		if data_state == "reached_pose1":
			local_pos_pub.publish(pose2)
			print("pushed data successfullu pose 2")

		if ((round(gx) == 10) and (round(gy) == 0) and (round(gz) == 10)):
			print("############################  Reached Pose 2  %%%%%%%%%%%%")
			data_state = "reached_pose2"
			rospy.sleep(2000)

		if data_state == "reached_pose2":
			local_pos_pub.publish(pose3)
			print("pushed data successfullu pose 3")
		
		if ((round(gx) == 10) and (round(gy) == 10) and (round(gz) == 10)):
			print("############################  Reached Pose 3  %%%%%%%%%%%%")
			data_state = "reached_pose3"
			rospy.sleep(2000)

		if data_state == "reached_pose3":
			local_pos_pub.publish(pose4)
			print("pushed data successfullu pose 4")

		if ((round(gx) == 0) and (round(gy) == 10) and (round(gz) == 10)):
			print("############################  Reached Pose 4  %%%%%%%%%%%%")
			data_state = "reached_pose4"
			rospy.sleep(2000)

		if data_state == "reached_pose4":
			local_pos_pub.publish(pose1)
			data_comp = "Complete"
			print("pushed data successfullu pose 5")

		if ((round(gx) == 0) and (round(gy) == 0) and (round(gz) == 10) and data_comp == "Complete"):
			print("############################  Reached Pose 4  %%%%%%%%%%%%")
			data_state = "reached_pose5"
			rospy.sleep(2000)

		if data_state == "reached_pose5":
			local_pos_pub.publish(pose0)
			print("pushed data successfullu pose 6")

		if ((round(gx) == 0) and (round(gy) == 0) and (round(gz) == 0) and data_comp == "Complete"):
			print("############################  Reached Pose final  %%%%%%%%%%%%")
			data_state = "reached_pose6"
			rospy.sleep(2000)

		if data_state == "reached_pose6":
			arm_cmd.value = False
			break
