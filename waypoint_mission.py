...
# Calling the rosservices
    ...
    def auto_set_mode(self):
        ...
        try:
            ...
            print ("Service Set_mode call failed: %s"%f)
    ...
    def wpPush(self,index,wps):
        ...
        try:
        	...
        	print("Mission Successfully pushed")
        except rospy.ServiceException as g:
            print ("Service Set_mode call failed: %s"%g)
...
def main():
	...
	w = wayp0.setWaypoints(3,22,True,True,0.0,0.0,0.0,float('nan'),19.134641, 72.911706,10) # 22 for takeoff
	wps.append(w)

	w = wayp1.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),19.134617, 72.911886,10)
	wps.append(w)

	w = wayp2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),19.134434, 72.911817, 10) # 16 for following
	wps.append(w)

	w = wayp3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),19.134423, 72.911763, 10) # 21 for landing
	wps.append(w)
	
	w = wayp3.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),19.134423, 72.911763, 10) # 21 for landing
	wps.append(w)
